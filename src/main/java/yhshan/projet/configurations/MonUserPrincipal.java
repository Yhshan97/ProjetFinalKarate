...
public class MonUserPrincipal implements UserDetails {
    ...
    public MonUserPrincipal(Compte compte) {/*
        if (compte != null)
            ...
            this.compte = new Compte("","","",avatarDao.getOne("Inconnu"),null,null);*/
    }

    //public String getRole() { return compte.getRole().getNomRole();}
/*
    public String getGroupe(){
        return compte.getGroupe().getNomGroupe();
    }

    public int getPoints(){
        return compte.getPoints();
    }
    public int getCredits(){
        return compte.getCredits();
    }

    public String getAlias(){ return compte.getAlias(); }
...
*/
    ...
    public String toString() {
        return "Compte{" +
                ...
                ", role='" + compte.getRole().getNomRole() + '\'' +
                ", groupe='" + compte.getGroupe().getNomGroupe() + '\'' +
                '}';
    }
*/
